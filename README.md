...
This repository contains the **final, working version** of the "Blood Test Analyzer" assignment. The application analyzes user-uploaded blood test reports (PDF format), identifies abnormal values, finds relevant research articles, and provides actionable health advice using LLM-powered agents.
